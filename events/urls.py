...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<slug>[-\w]+)/apply', ApplyToEvent.as_view(),
                           name='eventapplication'),
                       url(r'^(?P<slug>[-\w]+)/confirm/$', confirm_event,
                           name='eventconfirmation'),
                       url(r'^(?P<slug>[-\w]+)/transportation/$',
                           FillInTransport.as_view(), name='eventtransportation'),
                       url(r'^(?P<slug>[-\w]+)/transportation/update',
                           UpdateTransport.as_view(), name='updatetransportation'),
)
