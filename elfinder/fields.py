        ...
        if self._info is None:
            ...
            if not self.hash:
                ...
                try:
                    ...
                    if not 'dim' in info and 'mime' in info and info['mime'].startswith(
                            'image'):
...
class ElfinderFormField(CharField):
    ...
    def __init__(self, optionset, start_path, *args, **kwargs):
        ...
        #TODO: elfinder widget should be initialized using possible client options
        # from model field declaration
        self.optionset = optionset
