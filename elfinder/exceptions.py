...
class ElfinderErrorMessages:
    ...
    ERROR_UPLOAD_TOTAL_SIZE = 'errUploadTotalSize'  #'Data exceeds the maximum allowed
    #  size.'
    ...
    ERROR_NOT_REPLACE = 'errNotReplace'  #Object "$1" already exists at this location
    # and can not be replaced with object of another type.
    ERROR_SAVE = 'errSave'
