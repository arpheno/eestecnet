(function (f, e, b, g, c, d, h) {/*! Jssor */
    ...
    var k = f.$JssorEasing$ = {
        ...
        i.$SetStyleTransform = function (b, a) {
            if (Z())pb(i.$CreateCallback(g, X, b, a)); else X(b, a)
        };
        ...
        i.$DeselectElements = function () {
            if (e.selection)e.selection.empty(); else f.getSelection && f.getSelection().removeAllRanges()
        };
        ...
        i.$EnableElement = function (a, b) {
            if (b)i.$Attribute(a, "disabled", c); else i.$RemoveAttribute(a, "disabled")
        };
        ...
        i.$BuildElement = function (c, h, j, i) {
            if (i)c = T(c);
            var d = P(c, h);
            if (!d.length)d = a.$GetElementsByTag(c, h);
        ...
        i.$Transform = function (j, k, t, q, u, w, h) {
            ...
            if (j) {
                ...
                for (var e in k) {
                    ...
                    if (a.$IsNumeric(n))f = s + (n - s) * p; else {
    ...
    new function () {
        ...
        function K(g, f) {
            ...
            if (a.$IsFunction(e.$Easing))e.$Easing = {$Default: e.$Easing};
            ...
            e.$GetBlocks = function (b, a) {
                ...
                if (!e.$Blocks[f]) {
                    ...
                    for (var c = 0; c < e.$Cols; c++)for (var d = 0; d < e.$Rows; d++)e.$Blocks[f][d + "," + c] = {
                        $Top: d * a,
                        $Right: c * b + b,
                        $Bottom: d * a + a,
                        $Left: c * b
        ...
        function L(C, i, e, x, n, k) {
                ...
                if (d || z) {
                    ...
                    a.$Each(m, function (c, e) {
                        ...
                        if (c.$LastFrameIndex != d) {
                            if (!c.$LastFrameIndex && !j)a.$ShowElement(l[e]); else d == c.$Max && j && a.$HideElement(l[e]);
                            c.$LastFrameIndex = d;
            ...
            a.$Each(p, function (i, l) {
                a.$Each(i, function (K) {
                    ...
                    if (e.$Zoom || e.$Rotate) {
                        var L = c;
                        if (a.$IsBrowserIE() && a.$BrowserEngineVersion() < 9)if (e.$Cols * e.$Rows > 1)L = d; else M = d;
                        if (L) {
                    ...
                    if (M) {
                        if (e.$Clip) {
                            ...
                            if (F && C) {
                                p.$Top = h.$Height / 2 * x;
                                p.$Bottom = -p.$Top
                            } else if (F)p.$Bottom = -h.$Height * x; else if (C)p.$Top = h.$Height * x;
                            if (E && D) {
                                p.$Left = h.$Width / 2 * x;
                                p.$Right = -p.$Left
                            } else if (E)p.$Right = -h.$Width * x; else if (D)p.$Left = h.$Width * x
                        }
                        s.$Clip = u;
                        g.$Clip = h[y]
                    }
                    ...
                    a.$Each(f, function (b, c) {
                        if (a.$IsNumeric(b))if (b != g[c])s[c] = b - g[c]
                    });
                    v[y] = j ? g : f;
                    ...
                    for (var B = e.$FramesCount, I = 0; I <= B; I++) {
                        ...
                        a.$Each(s, function (f, c) {
                            ...
                            var j = l[d];
                            if (a.$IsNumeric(f))i[c] = g[c] + f * j; else {
        ...
        function m(q, lc) {
            ...
            function Ec(p, n) {
                ...
                function ab(b) {
                    if (b == Y && s == n) {
                        if (!h) {
                            var a = g;
                            if (B)if (B.$Index == n)a = B.$GetProcessor(); else B.$Clear();
                            Z();
                ...
                function P(d, c, j) {
                    if (d == n) {
                        if (d != c)D[c] && D[c].$ParkOut(); else!j && h && h.$AdjustIdleOnPark();
                        k && k.$Enable();
                        var l = Y = a.$GetNow();
                ...
                function N(b) {
                    if (V)a.$CancelEvent(b); else j.$TriggerEvent(m.$EVT_CLICK, n, b)
                }
                ...
                e.$LoadImage = function (d, b) {
                    ...
                    if (A.length && !G) {
                        ...
                        a.$LoadImages(A, f, a.$CreateCallback(g, I, d, b))
                    } else I(d, b)
                };
                ...
                function R(b, e, d) {
                    ...
                    if (!F) {
                        ...
                        if (o.$HWA && a.$WebKitVersion())(!X || a.$WebKitVersion() < 534 || !kb && !a.$IsBrowserChrome()) && a.$EnableHWA(b)
                    }
                    var g = a.$Children(b);
                    a.$Each(g, function (g) {
                        ...
                        if (i == "player" && !w) {
                            w = g;
                            if (w.pInstance)K(); else a.$AddEvent(w, "dataavailable", K)
                        }
                        if (i == "caption") {
                            if (!a.$IsBrowserIE() && !e) {
                                var h = a.$CloneNode(g);
            ...
            function Cc(F, h, q, v, u) {
                ...
                b.$Replay = function () {
                    ...
                    if (!C && !S && !t && s == h) {
                        ...
                        var i = T && (!K || G);
                        if (a == f)(e != f && !(K & 12) || i) && p.$GoForNextSlide(); else(i || a != e) && b.$PlayToPosition(d, z)
                    }
                };
            ...
            function dc(e, g) {
                ...
                if (a.$IsBrowserIE() && a.$BrowserVersion() >= 10 && a.$BrowserVersion() < 11)e.style.msTransform = "translate(" + c + "px, " + d + "px)"; else if (a.$IsBrowserChrome() && a.$BrowserVersion() >= 30 && a.$BrowserVersion() < 34) {
            ...
            function kc(e) {
                ...
                if (!C && (G || !(K & 12)) && !z.$IsPlaying()) {
                    ...
                    var d = b.abs(a - c);
                    d = 1 - b.pow(1 - d, 5);
                    if (!V && vb)z.$Continue(Pb); else if (c == a) {
                        yb.$EnablePlayer();
                        yb.$TryActivate()
                    } else z.$PlayCarousel(c, a, d * Zb)
                }
            }
                ...
                if (C && (!a.$IsBrowserIe9Earlier() || e.button)) {
                    ...
                    if (f) {
                        ...
                        if (x) {
                            ...
                            if (F && x && !Eb) {
                                a.$CancelEvent(e);
                                if (!S)z.$StandBy(xb); else z.$SetStandByPosition(xb)
            ...
            function pc() {
                U = {$Width: M, $Height: L, $Top: 0, $Left: 0};
                a.$Each(Z, function (b) {
                    a.$SetStyles(b, U);
                    a.$CssPosition(b, "absolute");
                    a.$CssOverflow(b, "hidden");
            ...
            var o = a.$Extend({
                ...
                $PlayOrientation: 1,
                $DragOrientation: 1
            }, lc), nb = o.$PlayOrientation & 3, bc = (o.$PlayOrientation & 4) / -4 || 1, cb = o.$SlideshowOptions, J = a.$Extend({
                $Class: r,
                $PlayInMode: 1,
                $PlayOutMode: 1
            }, o.$CaptionSliderOptions);
            a.$TranslateTransitions(J.$CaptionTransitions);
            ...
            o.$ArrowKeyNavigation && a.$AddEvent(e, "keydown", function (a) {
                if (a.keyCode == p.$LEFT)rb(-1); else a.keyCode == p.$RIGHT && rb(1)
            });
            var qb = o.$StartIndex;
    ...
    f.$JssorCaptionSlider$ = function (q, k, g) {
                    ...
                    if (f) {
                        ...
                        if (g && g.$Transition) {
                            ...
                            if (j) {
                                ...
                                if (!n)if (g.$BeginTime)i.$BeginTime = g.$BeginTime.$Value || 0; else if (o & 2)i.$BeginTime = 0
                            }
                        }
                        c.push(i)
                    }
        ...
        function n(x, d, A) {
            var h = {
                ...
                $Reverse: g && !A,
                $Optimize: c
            }, j = x, s = a.$ParentNode(x), n = a.$CssWidth(j), m = a.$CssHeight(j), z = a.$CssWidth(s), y = a.$CssHeight(s), f = {}, k = {}, l = d.$ScaleClip || 1;
            ...
            if (d.$Zoom || d.$Rotate) {
                ...
                var t = {
                    ...
                    $Bottom: m,
                    $Left: 0
                }, w = a.$Extend({}, t), e = w.$Offset = {}, v = d.$Clip & 4, q = d.$Clip & 8, u = d.$Clip & 1, r = d.$Clip & 2;
                if (v && q) {
                    e.$Top = m / 2 * l;
                    e.$Bottom = -e.$Top
