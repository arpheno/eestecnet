        ...
        function m(q, lc) {
            ...
            function Ec(p, n) {
                ...
                function R(b, e, d) {
                    ...
                    a.b(g, function (g) {
                        ...
                        if (i == "player" && !w) {
                            w = g;
                            if (w.pInstance)K(); else a.e(w, "dataavailable", K)
                        }
                        if (i == "caption") {
                            if (!a.Mb() && !e) {
                                var h = a.Q(g);
            ...
            function Cc(F, h, q, v, u) {
                ...
                b.dc = function () {
                    ...
                    if (!C && !S && !t && s == h) {
                        ...
                        j.g(o, h, a, l, g, e, f);
                        var i = T && (!K || G);
                        if (a == f)(e != f && !(K & 12) || i) && p.He(); else(i || a != e) && b.bd(d, z)
                    }
                };
                b.ke = function () {
                    e == f && e == b.ob() && b.G(g)
            ...
            function gb(g, f, k) {
                if (Vb && (!C || o.$NaviQuitDrag)) {
                    ...
                    if (!H)a = b.max(0, b.min(a, t - v)); else if (H & 2)a = u(a);
                    var j = (a - e) % t;
                    a = e + j;
            ...
            var o = a.i({
                ...
                $PlayOrientation: 1,
                $DragOrientation: 1
            }, lc), nb = o.$PlayOrientation & 3, bc = (o.$PlayOrientation & 4) / -4 || 1, cb = o.$SlideshowOptions, J = a.i({
                $Class: r,
                $PlayInMode: 1,
                $PlayOutMode: 1
            }, o.$CaptionSliderOptions);
            a.Vb(J.$CaptionTransitions);
            var bb = o.$BulletNavigatorOptions, O = o.$ArrowNavigatorOptions, I = o.$ThumbnailNavigatorOptions, W = !o.$UISearchMode, w, A = a.B(q, "slides", W), jb = a.B(q, "loading", W) || a.hb(e), Ob = a.B(q, "navigator", W), hc = a.B(q, "arrowleft", W), ec = a.B(q, "arrowright", W), Nb = a.B(q, "thumbnavigator", W), sc = a.j(A), rc = a.k(A), U, Z = [], Bc = a.K(A);
            a.b(Bc, function (b) {
                b.tagName == "DIV" && !a.D(b, "u") && Z.push(b)
            });
            var s = -1, Cb, yb, t = Z.length, M = o.$SlideWidth || sc, L = o.$SlideHeight || rc, ac = o.$SlideSpacing, Fb = M + ac, Gb = L + ac, fc = nb & 1 ? Fb : Gb, v = b.min(o.$DisplayPieces, t), ob, x, N, Eb, hb, X, R = [], Ub, Wb, Sb, jc, Ic, T, K = o.$PauseOnHover, Zb = o.$SlideDuration, wb, kb, mb, Vb = v < t, H = Vb ? o.$Loop : 0, Q, V, G = 1, S, C, Y, zb = 0, Ab = 0, F, ib, lb, Kb, y, fb, z, Xb = new vc, eb;
            T = o.$AutoPlay;
            j.Sb = lc;
            pc();
            q["jssor-slider"] = c;
            ...
            mb = kb || v >= t || !(H & 1) ? 0 : o.$ParkingPosition;
            ...
            var qb = o.$StartIndex;
            if (!(H & 1))qb = b.max(0, b.min(qb, t - v));
            z.Jb(qb, qb, 0)
        }
