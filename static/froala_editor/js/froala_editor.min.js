...
!function (a) {
    ...
    b.initializers = [], b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI", "TD", "TH"], b.LANGS = [], b.DEFAULTS = {allowedAttrs: ["title", "href", "alt", "src", "style", "width", "height", "target", "rel", "name", "value", "type", "colspan", "rowspan", "size", "color", "cellpadding", "cellspacing", "valign", "align", "autocomplete", "background", "bgcolor", "contenteditable", "tabindex", "data-.*", "contenteditable", "tabindex"], allowedTags: ["div", "p", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "pre", "blockquote", "table", "thead", "tbody", "tfoot", "tr", "th", "td", "span", "b", "u", "i", "strong", "em", "strike", "img", "ul", "ol", "li", "iframe", "object", "a", "main", "section", "article", "nav", "header", "aside", "figure", "figurecaption", "footer", "details", "summary", "mark", "time", "sub", "sup"], alwaysBlank: !1, alwaysVisible: !1, autosave: !1, autosaveInterval: 1e4, blockTags: ["n", "p", "blockquote", "pre", "h1", "h2", "h3", "h4", "h5", "h6"], buttons: ["bold", "italic", "underline", "strikeThrough", "fontSize", "fontFamily", "color", "sep", "formatBlock", "blockStyle", "align", "insertOrderedList", "insertUnorderedList", "outdent", "indent", "sep", "createLink", "insertImage", "insertVideo", "insertHorizontalRule", "undo", "redo", "html"], crossDomain: !0, customButtons: {}, customDropdowns: {}, customText: !1, defaultImageWidth: 300, direction: "ltr", disableRightClick: !1, editInPopup: !1, editorClass: "", formatTags: ["p", "pre", "blockquote", "h1", "h2", "h3", "h4", "h5", "h6", "div", "ul", "ol", "li", "table", "tbody", "thead", "tfoot", "tr", "th", "td"], headers: {}, height: "auto", icons: {}, inlineMode: !0, initOnClick: !1, language: "en_us", linkList: [], linkText: !0, linkClasses: {}, maxHeight: "auto", minHeight: "auto", noFollow: !0, paragraphy: !0, placeholder: "Type something", plainPaste: !1, preloaderSrc: "", saveURL: null, saveParams: {}, saveRequestType: "POST", simpleAmpersand: !1, shortcuts: !0, spellcheck: !1, theme: null, toolbarFixed: !0, trackScroll: !1, unlinkButton: !0, tabSpaces: !0, typingTimer: 200, pastedImagesUploadRequestType: "POST", pastedImagesUploadURL: null, width: "auto", withCredentials: !1, zIndex: 1e3}, b.prototype.destroy = function () {
        ...
        var c = [], d = ["SPAN", "A", "B", "I", "EM", "U", "S", "STRONG", "STRIKE", "FONT", "IMG", "SUB", "SUP"], e = this, f = function () {
            if (0 !== c.length) {
                var b;
        ...
        if (this.$pasteDiv.remove(), b = b.replace(/<img /gi, '<img data-fr-image-pasted="true" '), a(window).scrollTop(this.scrollPosition), this.restoreSelection(), this.options.plainPaste)this.insertHTML(b.replace(/<(?!br\s*\/?)[^>]+>/g, "")); else {
            var c;
            c = b.match(/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/gi) ? this.wordClean(b) : this.clean(b, !1, !0);
            for (var d = !1, e = a("<div>").append(c).find("*"), f = 0; f < e.length; f++)if (a.Editable.VALID_NODES.indexOf(e[f].tagName) >= 0) {
        ...
        this.$element.find("img[data-fr-image-pasted]").each(a.proxy(function (b, c) {
            ...
            }, this), 10), a.ajax({type: this.options.pastedImagesUploadRequestType, url: this.options.pastedImagesUploadURL, data: {image: decodeURIComponent(c.src)}, crossDomain: this.options.crossDomain, xhrFields: {withCredentials: this.options.withCredentials}, headers: this.options.headers, dataType: "json"}).done(a.proxy(function (b) {
                try {
                    if (b.link) {
                        var d = new Image;
        ...
        for (d = 0; d < a.length; d++)if (c = a.charAt(d), "<" == c) {
            ...
            if (-1 !== k) {
                ...
                if ("pre" === m && (j = n ? !1 : !0), this.isSelfClosingTag(l))i.push("br" === m && j ? "\n" : l); else if (n)for (e = !1, f = !0; e === !1 && void 0 !== f;)f = h.pop(), void 0 !== f && f.tag_name !== m ? i.splice(f.i, 1) : (e = !0, void 0 !== f && i.push(l)); else i.push(l), h.push({tag_name: m, i: i.length - 1});
                d = k
            }
        ...
        return JSON.stringify({body: this.$element.html(), href: this.$element.attr("href"), title: this.$element.attr("title"), popout: this.$element.hasClass("popout"), nofollow: "nofollow" == this.$element.attr("ref"), blank: "_blank" == this.$element.attr("target"), left: this.$element.parents(".navbar-left").length > 0, "class": this.$element.attr("class").replace(/froala-element/, "").replace(/not-msie/, "").replace(/ +(?= )/g, "").split(" ").sort().join(" ")})
        ...
        this.$element.on("keydown", a.proxy(function (a) {
            var b, c = a.which;
            if (9 != c || a.shiftKey)9 == c && a.shiftKey && (this.raiseEvent("shift+tab") ? (b = this.currentCell(), this.options.tabSpaces && !b ? a.preventDefault() : b && this.prevCell() && (a.preventDefault(), this.setSelection(this.prevCell()))) : a.preventDefault()); else if (this.raiseEvent("tab"))if (b = this.currentCell(), this.options.tabSpaces && !b) {
                a.preventDefault();
                var d = "&nbsp;&nbsp;&nbsp;&nbsp;", e = this.getSelectionElements()[0];
                "PRE" === e.tagName && (d = "    "), this.insertHTML(d, !1)
            } else b && this.nextCell() && (a.preventDefault(), this.setSelection(this.nextCell())); else a.preventDefault()
        }, this))
        ...
        if (!this.isHTML) {
            ...
            if ("" === this.text() && c && (0 === c.startOffset || c.startContainer === this.$element.get(0))) {
                ...
                if (f.length >= 1 && f[0] !== this.$element.get(0))for (d = 0; d < f.length; d++)if (e = f[d], !this.textEmpty(e))return void this.setSelection(e);
                for (f = this.$element.find(b.VALID_NODES.join(",")), d = 0; d < f.length; d++)if (e = f[d], !this.textEmpty(e))return void this.setSelection(e);
        ...
        this.$element.on("focus", a.proxy(function () {
            ...
            if (!this.isHTML)if (this.isEmpty() && !this.fakeEmpty()) {
        ...
        var b = this.buildDropdownAlign(a), c = this.buildDropdownButton(a, b, "fr-selector");
        ...
        for (var f in b.options) {
            var g = a('<a href="#">' + f + "</a>"), h = a("<li>").append(g);
            this.callDropdown(g, b, f), e.append(h)
        }
        return a(d).append(e)
    }, b.prototype.buildDropdownButton = function (a, b, c) {
        c = c || "";
        var d = '<div class="fr-bttn fr-dropdown ' + c + '" data-name="' + a.cmd + '">', e = '<button type="button" class="fr-trigger" title="' + a.title + '">' + this.addButtonIcon(a) + "</button>";
    ...
    a.Editable.commands = {bold: {title: "Bold", icon: "fa fa-bold", shortcut: "(Ctrl + B)"}, italic: {title: "Italic", icon: "fa fa-italic", shortcut: "(Ctrl + I)"}, underline: {cmd: "underline", title: "Underline", icon: "fa fa-underline", shortcut: "(Ctrl + U)"}, strikeThrough: {title: "Strikethrough", icon: "fa fa-strikethrough"}, subscript: {title: "Subscript", icon: "fa fa-subscript"}, superscript: {title: "Superscript", icon: "fa fa-superscript"}, formatBlock: {title: "Format Block", icon: "fa fa-paragraph", seed: [
        {value: "n", title: "Normal"},
        {value: "p", title: "Paragraph"},
        {value: "pre", title: "Code"},
    ...
    ]}, align: {title: "Alignment", icon: "fa fa-align-center", seed: [
        {cmd: "justifyLeft", title: "Align Left", icon: "fa fa-align-left"},
        {cmd: "justifyCenter", title: "Align Center", icon: "fa fa-align-center"},
        {cmd: "justifyRight", title: "Align Right", icon: "fa fa-align-right"},
        {cmd: "justifyFull", title: "Justify", icon: "fa fa-align-justify"}
    ]}, outdent: {title: "Indent Less", icon: "fa fa-dedent", activeless: !0, shortcut: "(Ctrl + <)"}, indent: {title: "Indent More", icon: "fa fa-indent", activeless: !0, shortcut: "(Ctrl + >)"}, selectAll: {title: "Select All", icon: "fa fa-file-text", shortcut: "(Ctrl + A)"}, createLink: {title: "Insert Link", icon: "fa fa-link", shortcut: "(Ctrl + K)"}, insertImage: {title: "Insert Image", icon: "fa fa-picture-o", activeless: !0, shortcut: "(Ctrl + P)"}, undo: {title: "Undo", icon: "fa fa-undo", activeless: !0, shortcut: "(Ctrl+Z)", disabled: function () {
        return!0
    }}, redo: {title: "Redo", icon: "fa fa-repeat", activeless: !0, shortcut: "(Shift+Ctrl+Z)", disabled: function () {
        return!0
    }}, html: {title: "Show HTML", icon: "fa fa-code"}, save: {title: "Save", icon: "fa fa-floppy-o"}, insertHorizontalRule: {title: "Insert Horizontal Line", icon: "fa fa-minus"}}, a.Editable.prototype.execCommand = {formatBlock: function (a, b) {
        this.formatBlock(b)
    }, createLink: function () {
        this.insertLink()
        ...
        for (var f, g = 0; g < e.length; g++) {
            var h = a(e[g]);
            if (!this.fakeEmpty(h))if (f = "n" == b ? this.options.paragraphy ? a("<div>").html(h.html()) : h.html() + "<br/>" : a("<" + b + ">").html(h.html()), h.get(0) != this.$element.get(0) && "LI" !== f.get(0).tagName && "TD" !== f.get(0).tagName && "TH" !== f.get(0).tagName) {
                var i = h.prop("attributes");
                if (f.attr)for (var j = 0; j < i.length; j++)"class" !== i[j].name && f.attr(i[j].name, i[j].value);
                var k;
                this.options.blockStyles && this.options.blockStyles[b], void 0 === k && (k = this.options.defaultBlockStyle);
                try {
                    if (h.hasClass(c) && h.get(0).tagName.toLowerCase() === b)f.addClass(h.attr("class")).removeClass(c); else {
                        if (void 0 === h.attr("class") || void 0 === k || !this.options.blockStylesToggle && "toggle" != d)f.addClass(h.attr("class")); else for (var l = h.attr("class").split(" "), m = 0; m < l.length; m++) {
                            var n = l[m];
        ...
        for (var e = 0; e < d.length; e++) {
            ...
            if (f.parentsUntil(this.$element, "li").length > 0 && (f = f.closest("li")), "LI" === f.get(0).tagName && a.isFunction(this.indentLi)) {
                ...
                var j = parseInt(f.css("margin-left").replace(/px/, ""), 10), k = Math.max(0, j + c);
                f.css("marginLeft", k)
            } else {
    ...
    a.Editable.prototype._events = {}, a.Editable.prototype.addListener = function (a, b) {
        ...
        if (d)for (var e = 0, f = d.length; f > e; e++)c = d[e].apply(this, b);
        return void 0 === c && (c = !0), c
    }
}(jQuery), function (a) {
    a.Editable.prototype.active_dispatcher = {fontFamily: function (a, b) {
    ...
    a.Editable.prototype.refresh_disabled = ["createLink", "insertImage", "undo", "redo", "save"], a.Editable.prototype.refresh_dispatcher = {fontSize: function (a) {
    ...
    a.Editable.prototype.text = function () {
        ...
        if (b.rangeCount) {
            ...
            if (1 != d.nodeType)d = d.parentNode; else {
                var e = !1;
    ...
    a.Editable.prototype.getBoundingRect = function () {
        ...
        if (this.options.inlineMode || b) {
            if (c = this.getBoundingRect(), this.showBttnWrapper(), c.ok || c.left >= 0 && c.top >= 0 && c.right > 0 && c.bottom > 0)d = c.left + c.width / 2, e = c.top + c.height, this.iPad() || (d += a(window).scrollLeft(), e += a(window).scrollTop()), this.showByCoordinates(d, e); else if (this.options.alwaysVisible)this.hide(); else {
    ...
    a.Editable.prototype.showLinkWrapper = function () {
        ...
        if (f === !0 && /^https?:\/\//.test(b) && (h = 'rel="nofollow"'), e === !0 && (i = 'target="_blank"'), b = this.sanitizeURL(b), this.imageMode) {
            ...
            if (this.isLink ? "" === c && (c = this.$element.text()) : (this.restoreSelection(), g = this.getSelectionLinks(), g.length > 0 && (k = g[0].attributes), this.saveSelectionByMarkers(), document.execCommand("unlink", !1, b), this.$element.find('span[data-fr-link="true"]').each(function (b, c) {
                ...
                for (var l = 0; l < g.length; l++) {
                    if (k)for (var m = 0; m < k.length; m++)"href" != k[m].nodeName && a(g[l]).attr(k[m].nodeName, k[m].nodeValue);
        ...
        if (window.getSelection) {
            ...
            if (f.getRangeAt && f.rangeCount) {
                ...
                for (var g = 0; g < f.rangeCount; ++g)if (a = f.getRangeAt(g), b = a.commonAncestorContainer, 1 != b.nodeType && (b = b.parentNode), "a" == b.nodeName.toLowerCase())e.push(b); else {
    ...
    a.Editable.TAG_ORDER = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "ul", "ol", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div", "a", "strong", "em", "strike", "u", "span", "iframe", "object", "param"], a.Editable.SEPARATE = ["th", "td", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div"], a.Editable.END_AT_SAME_INDEX = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "a", "span", "iframe", "div", "object", "param"], a.Editable.prototype.isClosingTag = function (a) {
        ...
        for (var c, d, e, f, g = 0, h = 0, i = [], j = "", k = [], l = {}, m = {}, n = 0; n < b.length; n++)if (c = b.charAt(n), "<" == c) {
            var o = b.indexOf(">", n + 1);
            if (-1 !== o) {
                if (h++, d = b.substring(n, o + 1), f = this.tagName(d), "b" == f && (f = "strong"), "i" == f && (f = "em"), this.isSelfClosingTag(d)) {
                    m[g] || (m[g] = []), m[g].push({i: h, content: d}), n = o;
                    continue
                }
                var p = this.isClosingTag(d), q = null, r = d.replace(/^<[\S\s]* style=("[^"]+"|'[^']+')[\S\s]*>$/gi, "$1"), s = {};
                if (r != d && (r = r.substring(1, r.length - 1), matches = r.match(/([^:]*):([^:;]*;|$)/gi)))for (var t = 0; t < matches.length; t++) {
                    var u = matches[t].split(":"), v = u.slice(1).join(":").trim();
                    ";" == v[v.length - 1] && (v = v.substr(0, v.length - 1)), s[u[0]] = v
                }
                if (q = d.match(/([\w\-]*)=("[^<>"]*"|'[^<>']*'|\w+)/gi))for (var w = 0; w < q.length; w++)0 === q[w].indexOf("style=") && q.splice(w, 1);
                if (p) {
                    var x = l[f].pop();
                    g == i[x].start && a.Editable.END_AT_SAME_INDEX.indexOf(f) >= 0 && (m[g] || (m[g] = []), m[g].push({i: i[x].i, content: i[x].original}), m[g].push({i: h, content: d}))
                } else i.push({type: f, attrs: q, style: s, start: g, i: h, original: d}), l[f] || (l[f] = []), l[f].push(i.length - 1);
                n = o
            }
        } else {
            j += c, k[g] = {};
        ...
        return{text: j, format: A, simple_tags: m}
        ...
        var c, d, e, f, g = this.mapDOM(b), h = this.froalaDOM(g.format), i = g.simple_tags, j = g.text, k = {};
        for (d = 0; d < h.length; d++)c = h[d], k[c.start] || (k[c.start] = []), k[c.start].push(c);
        var l = {};
        for (b = "", d = 0; d <= j.length; d++) {
            var m = [];
            if (i[d])for (i[d] = i[d].sort(this.sortSimpleTags), f = 0; f < i[d].length; f++)b += i[d][f].content;
            if (l[d]) {
                for (var n in l)if (n > d)for (e = 0; e < l[n].length; e++) {
                    var o = l[n][e];
            ...
            if (k[d])for (k[d] = k[d].sort(this.sortNodes), e = 0; e < k[d].length; e++)c = k[d][e], l[c.end] || (l[c.end] = []), l[c.end].push(c), b += this.openTag(c);
            d != j.length && (b += j[d])
        }
        return b
        ...
        var e, f;
        if (c[0] != this.$element.get(0))for (var g = 0; g < c.length; g++) {
            var h = a(c[g]);
