...
(function ($) {
            ...
            xhr: function (data, fm) {
                ...
                xhr.addEventListener('load', function (e) {
                    ...
                    if (res._chunkmerged) {
                        formData = new FormData();
                        var _file = [
                            {_chunkmerged: res._chunkmerged, _name: res._name}
                        ];
                        chunkMerge = true;
     ...
     * @type String
     **/
    elFinder.prototype.version = '2.1_n (Nightly: 227fbeb)';
                    ...
                    select: function (fm) {
                        ...
                        if (self.inputs.host.find('span').length) {
                            fm.request({
                                ...
                                self.inputs.host.find('span').html(data.body.replace(/\{msg:([^}]+)\}/g, function (whole, s1) {
                                    return fm.i18n(s1, 'Dropbox.com');
                                }));
                            }).fail(function () {
                            });
                        }
                        ...
                        if (data.mode == 'makebtn') {
                            self.inputs.host.find('span').removeClass("elfinder-info-spinner");
                            self.inputs.host.find('input').hover(function () {
 ...
 * })
        ...
        return this.each(function () {
            ...
            if ($.isArray(cmd.variants)) {
                ...
                menu = $('<div class="ui-widget ui-widget-content elfinder-button-menu ui-corner-all"/>')
                    ...
                    .delegate('.' + item, 'mouseenter mouseleave', function () {
        ...
        this.not('.' + treeclass).each(function () {
            ...
            var c = 'class',
                 ...
                 */
                    ...
                    style: function (dir) {
                        return dir.icon ? 'style="background-image:url(\'' + dir.icon + '\')"' : '';
                    }
                },
    ...
    elFinder.prototype.commands.info = function () {
        ...
        this.exec = function (hashes) {
            ...
            var self = this,
                ...
                count = [],
                replSpinner = function (msg, name) {
                    dialog.find('.' + spclass + '-' + name).parent().html(msg);
                },
        ...
        this.exec = function () {
            var fm = self.fm,
                ...
                create = function () {
                    ...
                    return fm.dialog(content, opts).ready(function () {
    ...
    elFinder.prototype.commands.open = function () {
        ...
        this.getstate = function (sel) {
            ...
            return cnt == 1
                ? 0
                : (cnt && !this.fm.UA.Mobile) ? ($.map(sel,function (file) {
