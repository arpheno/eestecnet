    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_query_name=b'user',
                                         ...
                                         help_text=b'The groups this user belongs to. '
                                                   b'A user will  get all permissions '
                                                   b'granted to each of  their groups.'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='account',
            ...
            field=models.ManyToManyField(related_query_name=b'user',
                                         related_name='user_set', null=True,
                                         to='auth.Permission', blank=True),
            preserve_default=True,
        ),
    ]
