...
from apps.events.models import Event, Participation, Application, Transportation
from apps.feedback.factories import LegacyAnswerSetFactory, LegacyQuestionSetFactory
...
class LegacyTransportationFactory(factory.DjangoModelFactory):
    class Meta:
...
class LegacyParticipationFactory(factory.DjangoModelFactory):
    class Meta:
        model = Participation
...
class LegacyApplicationFactory(factory.DjangoModelFactory):
    class Meta:
        model = Application
...
class LegacyEventFactory(factory.DjangoModelFactory):
    class Meta:
        model = Event
    ...
    accessed."""
    feedbacksheet = factory.SubFactory(LegacyQuestionSetFactory)
    questionaire = factory.SubFactory(LegacyQuestionSetFactory)
