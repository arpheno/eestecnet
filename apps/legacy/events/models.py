...
class Event(models.Model):
    ...
    feedbacksheet = ForeignKey('feedback.QuestionSet', null=True, blank=True,
                               related_name="events")
    questionaire = models.ForeignKey('feedback.QuestionSet', blank=True, null=True,
                                     related_name="eventstwo",
                                     help_text="Optional: If you want your "
                                               "participants to answer more questions "
                                               "other than writing about their "
                                               "motivation, you can include it here")
