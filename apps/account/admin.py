...
from apps.account.forms import EestecerChangeForm, EestecerCreationForm
from apps.account.models import Eestecer, Achievement, Position
...
class EestecerAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('first_name', 'last_name', 'thumbnail')}),
